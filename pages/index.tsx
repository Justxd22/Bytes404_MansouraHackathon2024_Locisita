          ...
          <ul className="shop-data-items">
            <li>
              ...
              <div className="data-item__content">
                <h4>All Home Local Brands Are here!</h4>
                <p>
                  Why miss out on local sales in small busniess stores
                </p>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="data-item__content">
                <h4>Easy Payments</h4>
                <p>
                  All payments securly using local solutions
                </p>
              </div>
            </li>
